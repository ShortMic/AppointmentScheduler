...
/**
 * The ModifyCustomerController which is responsible for the logic behind ModifyCustomerView. It helps provide I/O
 * functionality and acts as an interface between the front end GUI and backend database and provides user data validation,
 * error handling and local cache storage for editing pre-existing Customer POJOs. It also pre-populates the GUI fields based
 * on the previous screen's selected Customer in the Customer Table.
 *
...
public class ModifyCustomerController implements Initializable{
    ...
    /**
     * Event handler/listener that fires from the Modify button and attempts to save and update the associated Customer
     * with the field input to the local cache and database.
     * @param actionEvent Pre-generated and auto-handled event argument.
     */
